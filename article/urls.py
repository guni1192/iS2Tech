...
urlpatterns = [
    ...
    url(r'^(?P<pk>\d+)/detail$', views.ArticleDetailView.as_view(), name='detail'),
    url(r'^(?P<pk>\d+)/update$', views.UpdateArticleView.as_view(), name='update'),
    url(r'^(?P<pk>\d+)/delete$', views.DeleteArticleView.as_view(), name='delete'),
]
